...
- **Not included** (would require a paid backend + database, incompatible with free GitHub Pages): user accounts/login, saved templates, bookmarks, community forum.

## 📁 Project structure

```
devopshub-ai/
├── index.html              ← homepage (3D hero, features, roadmap preview)
